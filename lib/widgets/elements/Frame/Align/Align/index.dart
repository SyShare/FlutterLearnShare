...
import 'package:flutter_one/widgets/widget_demo.dart';
import './demo.dart';
...
Column _alignCreates() {
  return Column(
    children: <Widget>[
      ...
      AlignFactor(Alignment.topRight, 1, 1, 'topleft'),
      AlignFactor(Alignment.center, 1, 1, 'center'),
      AlignFactor(Alignment.bottomLeft, 1, 1, 'bottomLeft')
    ],
  );
}

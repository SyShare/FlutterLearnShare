...
class CollapsibleBody extends StatelessWidget {
  const CollapsibleBody(
      {this.margin = EdgeInsets.zero, required this.child,required this.onSave,required this.onCancel});
...
class DemoItem<T> {
  DemoItem({this.name,required this.value, this.hint,required this.builder,required this.valueToString})

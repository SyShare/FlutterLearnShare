...
class DualHeaderWithHint extends StatelessWidget {
  const DualHeaderWithHint({required this.name,required  this.value,required  this.hint,required  this.showHint});
...
class DemoItem<T> {
  DemoItem({required this.name,required this.value,required this.hint,required this.builder,required this.valueToString})
